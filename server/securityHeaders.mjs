export const securityHeaders = {
    'Content-Security-Policy': `
        ...
        connect-src 'self' connect-src 'self' http://localhost:3000 ws://localhost:3000 wss: https://*.firebaseio.com https://identitytoolkit.googleapis.com https://securetoken.googleapis.com wss:;
